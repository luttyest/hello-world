...
nodeinit = 30
hiddenlayerinit = (nodeinit, nodeinit, nodeinit, nodeinit, nodeinit)

i = 0
hiddenlayernodewanted = 10
while i < hiddenlayernodewanted:
    # hidden layer modify
...
with open("errorcompare2.csv", 'w') as outfile:
